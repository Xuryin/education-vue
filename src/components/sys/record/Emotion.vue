    ...
    <div class="my-padding-10">
        ...
        <el-row class="my-margin-top-10">
            <el-breadcrumb separator-class="el-icon-arrow-right">
                ...
                <el-breadcrumb-item>情绪放松</el-breadcrumb-item>
            </el-breadcrumb>
        </el-row>
        ...
        <el-row class="my-margin-top-20" :gutter="10">
            ...
            <!--<el-col :span="3">-->
                <!--<el-cascader-->
                    <!--:options="table.cognitionOptions" :show-all-levels="true"-->
                    <!--v-model="table.cognitionSelect" size="small" clearable-->
        ...
        <el-row class="my-margin-top-10">
            <el-table :data='table.tableData' border stripe style="width:100%" size="small" :highlight-current-row="true" ref="multipleTable">
                ...
                <el-table-column label='放松课程名称' prop="emotionName" width="150" show-overflow-tooltip></el-table-column>
                ...
                <el-table-column label='结果图' prop="resultPic" width="80">
                    <template slot-scope="scope">
                        <img :src='scope.row.resultPic' alt="" style="height: 50px"/>
                    </template>
                </el-table-column>
...
export default {
    ...
    methods: {
        ...
        getTableData(){
            ...
            p.emotionId = this.table.emotionId;
            if(this.table.time){
        ...
        // getCourseList(){
        //     let p = {};
        //     let url = '/emotion/listemotion';
        //     this.$http.fetch(url,p)
        //         .then(res=>{
        //             this.table.cognitionOptions = this.setCourseList(res.data);
        //         })
        // },
        ...
        //认知项目选择
        cognitionChange(value){
            if(value.length==0){
                this.table.cognitionId = '';
                this.table.gradeNum = '';
                ...
                this.table.gradeNum = value[0];
                this.table.cognitionId = value[1];
            }
            this.table.currentPage = 1;
            this.getTableData();
        },

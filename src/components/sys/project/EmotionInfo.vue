    ...
    <div class="my-padding-10">
        ...
        <el-row class="my-margin-top-10">
            <el-breadcrumb separator-class="el-icon-arrow-right">
                ...
                <el-breadcrumb-item>情绪放松信息</el-breadcrumb-item>
            </el-breadcrumb>
        </el-row>
        ...
        <el-row class="my-margin-top-20" :gutter="10">
            <el-col :span="3">
                <el-input size="small" placeholder="请输入放松类型" suffix-icon="el-icon-search" :clearable='true' @clear="cleanKey" v-model="table.queryKey"
        ...
        <el-row class="my-margin-top-10">
            <el-table :data='table.tableData' border stripe style="width:100%"
                ...
                <el-table-column label='编号' prop="emotionId"></el-table-column>
                <el-table-column label='任务类型' prop="workType"></el-table-column>

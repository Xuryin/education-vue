    ...
    <div class="my-padding-10">
        ...
        <el-row class="my-margin-top-10">
            <el-breadcrumb separator-class="el-icon-arrow-right">
                ...
                <el-breadcrumb-item>趣味内容</el-breadcrumb-item>
            </el-breadcrumb>
        </el-row>
        <!--搜索栏-->
        <el-row class="my-margin-top-20" :gutter="10">
            <el-col :span="3">
                <el-input size="small" placeholder="请输入测试类型" suffix-icon="el-icon-search" :clearable='true' @clear="cleanKey" v-model="table.queryKey"
        ...
        <el-row class="my-margin-top-10">
            <el-table :data='table.tableData' border stripe style="width:100%"
                ...
                <el-table-column label='编号' prop="interestId" width="45"></el-table-column>
                <el-table-column label='测试类型' prop="testType" width="100"></el-table-column>
                <el-table-column label='训练内容' prop="testContent" width="350"></el-table-column>
                <el-table-column label='指导语' prop="guideline" width="250"></el-table-column>
                <el-table-column label='解释说明' prop="explains"></el-table-column>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getTableData() {
                let p = {};
                let url = "/interest/listQueryInfo";
